...
namespace gameplay {
    ...
    DestructableEntity::DestructableEntity(GameWorld& parent, b2Body& body, EntityType EntityType)
        : Entity(parent, body, EntityType)
        , m_wasInitialized(false)
    {
    }

    void DestructableEntity::initializeDestructableBehavior(const Image& textureSource)
    {
    ...
    void DestructableEntity::destroy(const DestructableEntityDestroyer& destroyer)
    {
        if (!m_wasInitialized)
            return;
    ...
    void DestructableEntity::destroyShape(const DestructableEntityDestroyer& destroyer)
    {
    ...
    void DestructableEntity::destroyTexture(const DestructableEntityDestroyer& destroyer)
    {
