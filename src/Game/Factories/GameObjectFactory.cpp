...
namespace game {
    namespace factories {
        ...
        Sprite GameObjectFactory::createSpriteFromTexture(Sprite& s, const Texture& texture, FloatRect scaleRect)
        {
        ...
        FloatRect GameObjectFactory::createFixturesFromSchema(const Document& schema, b2Body& body, Vector2f scale)
        {
